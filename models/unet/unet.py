...
class UNetModel(nn.Module):
    ...
    def forward(self, x, t, s=None, y=None):
        ...
        if self.input_step:
            ...
            emb = emb + self.s_emb(timestep_embedding(s, self.model_channels))
...
class UNetModelWrapper(UNetModel):
    ...
    def forward(self, x, t, s=None, y=None, *args, **kwargs):
        return super().forward(x, t, s=s, y=y)
